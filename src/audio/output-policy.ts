...
export const OUTPUT_POLICY_ENV_DEFAULTS = Object.freeze({
  PANOP_OUTPUT_MAX_WORDS: String(DEFAULT_OUTPUT_MAX_WORDS),
  PANOP_OUTPUT_ROUND_TRIP_BUDGET_MS: String(DEFAULT_OUTPUT_ROUND_TRIP_BUDGET_MS),
  PANOP_OUTPUT_WORKING_ACK_REPEAT_MS: String(DEFAULT_OUTPUT_WORKING_ACK_REPEAT_MS),
  PANOP_OUTPUT_SILENCE_TARGET: String(DEFAULT_OUTPUT_SILENCE_TARGET),
  PANOP_OUTPUT_SUMMARY_MODEL: DEFAULT_OUTPUT_SUMMARY_MODEL,
});
...
export function readOutputPolicyConfig(env: Record<string, string | undefined> = process.env): OutputPolicyConfig {
  return {
    maxWords: envPositiveInteger(env, "PANOP_OUTPUT_MAX_WORDS", DEFAULT_OUTPUT_MAX_WORDS),
    roundTripBudgetMs: envPositiveInteger(env, "PANOP_OUTPUT_ROUND_TRIP_BUDGET_MS", DEFAULT_OUTPUT_ROUND_TRIP_BUDGET_MS),
    workingAckRepeatMs: envPositiveInteger(env, "PANOP_OUTPUT_WORKING_ACK_REPEAT_MS", DEFAULT_OUTPUT_WORKING_ACK_REPEAT_MS),
    silenceTarget: envRatio(env, "PANOP_OUTPUT_SILENCE_TARGET", DEFAULT_OUTPUT_SILENCE_TARGET),
    summaryModel: env.PANOP_OUTPUT_SUMMARY_MODEL?.trim() || DEFAULT_OUTPUT_SUMMARY_MODEL,
  };
}
